...
########## 接口端配置
API_URL = "http://ip/api" #"https://github.com/" #'"http://192.168.7.101/api"  # 接口地址
...
########## 移动端配置
PLATFORM = 'ios'  #'Android'  # ios Android  平台 app 时配合
...
########## DB 配置
MYSQL = {'user': 'root', 'password': 'root', 'port': 3306, 'host': '127.0.0.1', 'db': 'redamanage'}
